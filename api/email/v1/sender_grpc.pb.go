...
const (
	Sender_SendMail_FullMethodName = "/api.email.v1.Sender/SendMail"
)
...
func (c *senderClient) SendMail(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*SendMailReply, error) {
	...
	err := c.cc.Invoke(ctx, Sender_SendMail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Sender_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.email.v1.Sender",
	...
	Metadata: "api/email/v1/sender.proto",
}
