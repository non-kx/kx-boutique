...
const OperationHealthHealthCheck = "/api.shop.v1.Health/HealthCheck"
...
func (c *HealthHTTPClientImpl) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...http.CallOption) (*HealthCheckResponse, error) {
