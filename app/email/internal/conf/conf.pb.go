...
type Data struct {
	...
	Smtp  *Data_Smtp  `protobuf:"bytes,1,opt,name=smtp,proto3" json:"smtp,omitempty"`
...
type Data_Smtp struct {
	...
	TemplatesDir string `protobuf:"bytes,5,opt,name=templates_dir,json=templatesDir,proto3" json:"templates_dir,omitempty"`
}

func (x *Data_Smtp) Reset() {
	*x = Data_Smtp{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_Smtp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Smtp) ProtoMessage() {}

func (x *Data_Smtp) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Smtp.ProtoReflect.Descriptor instead.
func (*Data_Smtp) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 0}
}

func (x *Data_Smtp) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *Data_Smtp) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
func (x *Data_Smtp) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *Data_Smtp) GetPwd() string {
	if x != nil {
		return x.Pwd
	}
	return ""
...
func (x *Data_Smtp) GetTemplatesDir() string {
	if x != nil {
		return x.TemplatesDir
	}
	return ""
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x90, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	0x12, 0x29, 0x0a, 0x04, 0x73, 0x6d, 0x74, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15,
	0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61,
	0x2e, 0x53, 0x6d, 0x74, 0x70, 0x52, 0x04, 0x73, 0x6d, 0x74, 0x70, 0x12, 0x2c, 0x0a, 0x05, 0x72,
	...
	0x69, 0x73, 0x52, 0x05, 0x72, 0x65, 0x64, 0x69, 0x73, 0x1a, 0x79, 0x0a, 0x04, 0x53, 0x6d, 0x74,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x72, 0x6f,
	...
	0x23, 0x0a, 0x0d, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x5f, 0x64, 0x69, 0x72,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65,
	0x73, 0x44, 0x69, 0x72, 0x1a, 0xb3, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18,
	...
	0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x2a, 0x5a, 0x28, 0x6b, 0x78,
	0x2d, 0x62, 0x6f, 0x75, 0x74, 0x69, 0x71, 0x75, 0x65, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x65, 0x6d,
	0x61, 0x69, 0x6c, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6e,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Smtp)(nil),           // 5: kratos.api.Data.Smtp
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Data.smtp:type_name -> kratos.api.Data.Smtp
